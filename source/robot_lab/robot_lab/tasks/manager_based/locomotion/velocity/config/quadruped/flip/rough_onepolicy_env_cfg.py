...
from robot_lab.assets.flip import FLIP_FERE_CFG
from .flip_env_cfg_onpolicy import OnepolicyVelocityRoughEnvCfg

@configclass
class FlipFERERoughEnvCfg(OnepolicyVelocityRoughEnvCfg):
    base_link_name = "base"
    ...
    structure_list = [FERE_POS, FERK_POS, FKRE_POS, FKRK_POS]
    ...
    def __post_init__(self):
        ...
        self.commands.structure_id.available_commands = list(range(len(self.structure_list)))
        self.events.sturcture_init.params["structure_list"] = self.structure_list

        self.scene.robot = FLIP_FERE_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        if self.__class__.__name__ == "FlipFERERoughEnvCfg":
