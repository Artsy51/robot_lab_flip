...
class FlipFERKRoughEnvCfg(flipVelocityRoughEnvCfg):
    ...
    def __post_init__(self):
        ...
        self.scene.robot = FLIP_FERK_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        self.rewards.raibert_heuristic.params["stance_length"] = 0.455
        ...
        if self.__class__.__name__ == "FlipFERKRoughEnvCfg":
