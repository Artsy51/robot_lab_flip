...
from robot_lab.assets.flip import FLIP_FKRE_CFG
from.flip_env_cfg import flipVelocityRoughEnvCfg

@configclass
class FlipFKRERoughEnvCfg(flipVelocityRoughEnvCfg):
    base_link_name = "base"
    ...
    def __post_init__(self):
        ...
        self.scene.robot = FLIP_FKRE_CFG.replace(prim_path="{ENV_REGEX_NS}/Robot")
        ...
        self.rewards.raibert_heuristic.params["stance_length"] = 0.513
        ...
        if self.__class__.__name__ == "FlipFKRERoughEnvCfg":
